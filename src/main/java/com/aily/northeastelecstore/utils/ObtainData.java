...
//		params.add(new BasicNameValuePair("orderDirection", "asc"));
        ...
        // 请求服务器url
        String url = Utils.primitiveUrl + "OrderDishes.php";
        // 获得请求对象HttpPost
    ...
    //上传组注册信息
    public static boolean postRegisterMsg(String usernameStr, String passwordStr, String nameStr, String phonenumStr){
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        // 添加请求参数
        params.add(new BasicNameValuePair("guuser", usernameStr));
        params.add(new BasicNameValuePair("gupwd", passwordStr));
        ...
        // 请求服务器url
        String url = Utils.primitiveUrl + "Register.php";
        // 获得请求对象HttpPost
        HttpPost request = HttpUtil.getHttpPost(url);
        // 设置查询参数
        request.setEntity(entity1);
