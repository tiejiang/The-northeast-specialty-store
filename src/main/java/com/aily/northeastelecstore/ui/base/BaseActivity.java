...
import com.aily.northeastelecstore.config.Constants;
import com.aily.northeastelecstore.image.ImageLoaderConfig;
import com.aily.northeastelecstore.task.AsyncCallable;
...
//獲得設備信息
 ...
 protected String getCountry() {
	...
	protected <T> void doAsync(final int pTitleResID, final int pMessageResID, final Callable<T> pCallable, final Callback<T> pCallback, final Callback<Exception> pExceptionCallback) {
		com.aily.northeastelecstore.task.EMobileTask.doAsync(this, pTitleResID, pMessageResID, pCallable, pCallback, pExceptionCallback);
	}
